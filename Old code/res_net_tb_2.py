...
class LayerTopoBlock(nn.Module):
    ...
    def __init__(self,in_channels, out_channels, identity_downsample, stride):
        ...
        self.block1 = TopoBlock(in_channels, out_channels,identity_downsample,64, stride)
...
class TopoBlock(nn.Module):
    def __init__(self, in_channels, out_channels, identity_downsample=None, topo_size_in =64, stride=1):
...
if __name__ == "__main__":
    ...
    train_set_path = 'train_set_land_norm.pkl'
    train_set_target_path = 'train_set_land_target_norm.pkl'

    test_set_path = 'test_set_land_norm.pkl'
    test_set_target_path = 'test_set_land_target_norm.pkl'
